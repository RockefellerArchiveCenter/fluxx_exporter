        ...
        for entity_data in inputs:
            ...
            try:
                ...
                if(fetch_sftp_configs('SFTP Test')):
                    ...
                    send_directory_over_sftp(host, username, password, local_dir, remote_dir)
            except Exception as e:
            ...
            try:
                ...
                if(fetch_s3_configs('S3 Config')):
                    ...
                    upload_directory_to_s3(local_dir, bucket, access_key, secret_key)
            except Exception as e:
...
def localDataExport(entity, json_data, fluxx, format):
    try:
        ...
        top_level_folder_path = os.path.join(os.getcwd(), top_level_folder_name)
